<template>
  <div>
    ...
    <el-table :data="ambientesTabla" style="width: 100%">
      <el-table-column prop="f005_nombre" label="Nombre" width="180"></el-table-column>
      <el-table-column prop="f005_descripcion" label="Descripcion" width="180"></el-table-column>
      <el-table-column prop="f005_capacidad" label="Capacidad" width="180"></el-table-column>
